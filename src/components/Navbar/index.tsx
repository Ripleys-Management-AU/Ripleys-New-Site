...
const Navbar = () => {
  ...
  return (
    <div className="fixed bg-black flex flex-row lg:flex-col justify-between lg:justify-center items-center pt-2 px-8 lg:px-0 pb-4 w-full lg:text-white top-0 z-[998]">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden w-screen left-0 items-start h-screen flex flex-col fixed px-6 pt-20 bg-white bg-opacity-50 backdrop-blur-lg z-[60] pointer will-change-opacity overflow-scroll top-0">
